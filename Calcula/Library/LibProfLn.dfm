object ProfLn: TProfLn
  Left = 227
  Top = 115
  HelpContext = 1
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Nerovnoramenn'#253' L profil'
  ClientHeight = 121
  ClientWidth = 369
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object LaLnMater: TLabel
    Left = 8
    Top = 2
    Width = 37
    Height = 13
    Caption = '&Materi'#225'l'
    FocusControl = EdLnMater
  end
  object LaLnRozmer: TLabel
    Left = 8
    Top = 42
    Width = 31
    Height = 13
    Caption = '&Pr'#367#345'ez'
    FocusControl = EdLnRozmer
  end
  object LaLnDelka: TLabel
    Left = 104
    Top = 42
    Width = 45
    Height = 13
    Caption = '&D'#233'lka [m]'
    FocusControl = EdLnDelka
  end
  object EdLnMater: TClrComboBox
    Left = 8
    Top = 16
    Width = 97
    Height = 21
    Hint = 'Materi'#225'l nerovnoramenn'#233'ho L profilu'
    ...
    TabOrder = 0
    OnChange = EdLnChange
    OnCreate = EdLnMaterCreate
  end
  object EdLnRozmer: TClrComboBox
    Left = 8
    Top = 56
    Width = 89
    Height = 21
    Hint = 'Pr'#367#345'ez nerovnoramenn'#233'ho L profilu'
    Style = csOwnerDrawVariable
    ItemHeight = 16
    Options = [SaveState]
    ParentShowHint = False
    ...
    TabOrder = 1
    OnChange = EdLnChange
    OnCreate = EdLnRozmerCreate
  end
  object EdLnDelka: TsiEdit
    Left = 104
    Top = 56
    Width = 75
    Height = 21
    Hint = 'D'#233'lka nerovnoramenn'#233'ho L profilu'
    Caption = '&D'#233'lka'
    ColorOK = clWindow
    ColorError = 13172735
    HelpProperties = 4
    HintOK = 'D'#233'lka nerovnoramenn'#233'ho L profilu'
    Measure = meDistance
  ...
  object ScrLn: TScrollBox
    ...
    BorderStyle = bsNone
    TabOrder = 3
    object LaLnHmot: TLabel
      Left = 0
      Top = 2
      Width = 66
      Height = 13
      Caption = '&Hmotnost [kg]'
      FocusControl = EdLnHmot
    end
    object LaLnPlocha: TLabel
      Left = 0
      Top = 42
      Width = 56
      Height = 13
      Caption = '&Plocha [m2]'
      FocusControl = EdLnPlocha
    end
    object EdLnPlocha: TsiComboEdit
      Left = 0
      Top = 56
      Width = 97
      Height = 21
      ...
      Text = '0'
      Units = UN_m2
      UnitLabel = LaLnPlocha
      OnButtonClick = EdButtonClick
      OnCompute = EdLnPlochaCompute
    end
    object EdLnHmot: TsiComboEdit
      Left = 0
      Top = 16
      Width = 97
      Height = 21
